            ...
            <div
                ...
                <div class="smf-p-6 smf-space-y-4 sm:smf-p-8">
                    ...
                    <form action="{{ url('/password/reset') }}" method="POST" id="reset-password"
						...
						<div>
							<label for="password_confirmation" class="smf-block smf-mb-2 smf-text-sm smf-font-medium smf-text-gray-900 dark:smf-text-white">{{ trans('auth.password_confirm') }}</label>
